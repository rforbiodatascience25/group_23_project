...
surv_count_per_gender_per_cancer
```
...
```{r}
surv_plot_glioma_gender <- ggsurvplot(
...
ggsave(here('results','figures', 'surv_count_per_gender_per_cancer.png'), surv_count_per_gender_per_cancer)
ggsave(here('results','figures', 'surv_count_per_gender.png'), surv_count_gender)
ggsave(here('results','figures', 'surv_count_per_gender_for_glioma.png'), surv_count_gender_glioma)
ggsave(here('results','figures', 'surv_plot_per_gender.png'), surv_plot_gender$plot)
ggsave(here('results','figures', 'surv_plot_per_gender_for_glioma.png'), surv_plot_glioma_gender$plot)
```
